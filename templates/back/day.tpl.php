    ...
    <div class="row no-front">
        ...
        <div class="form-group col-md-9">
            ...
            <input type="text" class="form-control" id="title" name="title"
                   value="<?= htmlspecialchars($this->data["row"]['title']) ?>"/>
        </div>
        <div class="form-group col-md-9">
            <label>Like:</label>
            <input type="number" class="form-control" id="like" name="like" size="5"
                   value="<?= $this->data["row"]['like'] ?>"/>
        </div>

        <div class="form-group col-md-9">
            <label>Share your memories of that day</label>
            <textarea class="form-control content" id="content"
                      name="content"><?= stripcslashes($this->data["row"]['content']) ?></textarea>
        </div>
        <div class="form-group col-md-9">
        ...
        <div class="col-md-10 form-contact form-group">
            <div class="form-group registering  col-xs-12 col-sm-4">
                ...
                <input type="text" class="full-name form-control" id="username" name="username"
                       value="<?= htmlspecialchars($this->data["row"]['username']) ?>">
            </div>
            ...
            <div class="form-group col-xs-12 col-sm-4">
                ...
                <input type="email" class="email form-control" id="email" name="email"
                       value="<?= htmlspecialchars($this->data["row"]['email']) ?>">
            </div>
            <div class="form-group registering col-xs-12 col-sm-4">
                <div class="icon">
                    <label class="website sr-only">Location</label>
                </div>
                <input type="text" class="website form-control" id="loc" name="loc"
                       value="<?= htmlspecialchars($this->data["row"]['location']) ?>">
            </div>
        </div>
        <div class="col-md-10 form-contact form-group">
