        ...
        foreach ($this->data["days"] as $day) {
            ...
            <tr id="row-<?= $day["id"] ?>">
                ...
                <td id="fb-post-<?= $day['id'] ?>">
                    <a title="Post to Facebook" href="javascript:void(0)" class="fb-post-button"
                       data-id="<?= $day['id'] ?>">
                        <span class="glyphicon glyphicon-send"></span>
                    </a>
                </td>
                <td><a title="Edit" href="/back/day/<?= $day['id'] ?>/"><span
                                class="glyphicon glyphicon-edit"></span></a></td>
                <td>
                    <a title="Remove" href="javascript:void(0)" class="remove-day" id="remove-day-<?= $day['id'] ?>"
                       data-day-id="<?= $day['id'] ?>">
