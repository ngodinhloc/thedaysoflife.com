...
{
    /**
     * @var FacebookResponse The response that threw the exc.
     */
    protected $response;
    ...
    /**
     * Returns the raw response used to create the exc.
     *
     * @return string
     */
    ...
    /**
     * Returns the decoded response used to create the exc.
     *
     * @return array
     */
    ...
    /**
     * Returns the response entity used to create the exc.
     *
